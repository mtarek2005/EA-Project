...
class SettingsWidget(Gtk.Box):
    ...
    def __init__(self):
        ...
        self.settings={'nodes':[25,self.nodes_spinbutton,self.nodes_spinbutton.get_value_as_int,self.nodes_spinbutton.set_value],
                       ...
                       'aco_i':[500,self.aco_i_spinbutton,self.aco_i_spinbutton.get_value_as_int,self.aco_i_spinbutton.set_value],
                       ...
                       'aco_i_2':[500,self.aco_i_spinbutton_2,self.aco_i_spinbutton_2.get_value_as_int,self.aco_i_spinbutton_2.set_value],
